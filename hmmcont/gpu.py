...
# sigma=(np.arange(N)  +1)*0.1  


# # M=1
# params=(N,M,p_0,pi,A,sigma)
# hmmb.check_ar_params(params)

# T=10000+1
    
# Y=hmmb.sim_ar(np.zeros(M-1),T,params)
...
# params=(N,M,p_0,pi,A,sigma,D,L,U,V)
# hmmb.check_arp_params(params)
...
# params_cpu=hmmb.arp_em_it(Y,params)
# for it in range(1,iters):
#     params_cpu=hmmb.arp_em_it(Y,params_cpu)


# params_gpu=arp_cuda_em_it(Y,params,iters=iters,block_size=32,n_blocks=32*32,report_time=True)


# # print(" ")
# # for el in range(len(params)-4):
# #     print(params_cpu[el])
# # print(" ")
