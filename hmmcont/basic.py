...
# Y=sim_ar(np.zeros(M-1),10000+1,params)
...
# for it in range(10):
#     params=ar_em_it(Y,params)
    
#     like=like_ar(Y, params)
...
# Y=sim_ar(np.zeros(M-1),T,params)
